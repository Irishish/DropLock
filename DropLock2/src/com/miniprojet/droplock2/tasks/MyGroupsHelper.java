...
public class MyGroupsHelper {
	...
	private static final String MyGroupsUrl =
			"https://secure.bluehost.com/~naturds2/droplock/v1/droplock_api/include/groups.php";
	private static final int HTTP_STATUS_OK = 200;
	private static byte[] buff = new byte[1024];
	private static final String logTag = "MyGroupsHelper";
	...
	protected static synchronized String downloadFromServer (String... params)
		...
		String url = MyGroupsUrl; //ADD - + "&idUser=" + idUser; for user specific groups
